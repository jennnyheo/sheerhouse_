            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						<%-- 입력 폼 --%>
						<form action="noticeUpdate.mdo" method="post" name="update">
						<input type="hidden" name="notice_num" value="${notice.notice_num }"/>
						<p>no.${notice.notice_num }</p>
						<input type="text" name="title" class="form-control mt-4 mb-2" value="${notice.title }" placeholder="제목을 입력해주세요.">
						<div class="form-group">
						<textarea class="form-control" rows="10" name="content" placeholder="내용을 입력해주세요">${notice.content }</textarea>
						</div>
