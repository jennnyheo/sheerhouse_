            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
						...
						<%-- 입력 폼 --%>
						<form action="termsInsert.mdo" method="post">
						<input type="text" name="title" class="form-control mt-4 mb-2" placeholder="분류">
						<input type="text" name="sub_title" class="form-control mt-4 mb-2" placeholder="조항">
